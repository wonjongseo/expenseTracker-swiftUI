...
extension Category {
    ...
    static let buillsAndUtilities = Category(id: 2, name: "Buills & Utilities", icon: .file_invoice_dollar)
    ...
    static let creditCardPayment = Category(id: 901, name: "CreditCard Payment", icon: .exchange_alt,mainCategoryId: 9)
}

extension Category {
    static let categoreis: [Category] = [
        .autoAndTransport,
        .buillsAndUtilities,
        .entertainment,
        .feesAndCharges,
    ...
    static let all: [Category] = categoreis + subCategories
}
